...
function _beforeViewOpen(params = {} as Object) as Dynamic
    return promises_chain(beforeViewOpen(params), params).then(function(response as Dynamic, params as Dynamic) as Dynamic
        return response
    end function).toPromise()
end function

function beforeViewOpen(params = {} as Object) as Dynamic
    return promises_resolve(Invalid)
end function

function _onViewOpen(params = {} as Object) as Dynamic
    return promises_chain(onViewOpen(params), params).then(function(response as Dynamic, params as Dynamic) as Dynamic
...
function _onRouteUpdate(event as object) as Dynamic
    return promises_chain(onRouteUpdate(event), event).then(function(response as Dynamic, event as Dynamic) as Dynamic
        return response
    end function).toPromise()
end function
