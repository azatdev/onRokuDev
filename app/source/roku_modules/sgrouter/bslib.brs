...
'
function sgrouter_bslib_toString(value)
...
'
function sgrouter_bslib_ternary(condition, consequent, alternate)
    if condition then
        return consequent
    else
        return alternate
...
'
function sgrouter_bslib_coalesce(consequent, alternate)
